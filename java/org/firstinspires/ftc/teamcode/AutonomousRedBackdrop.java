...
public class AutonomousRedBackdrop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            delay.reset();
            Pose2d startPose = new Pose2d(60, -150, Math.toRadians(90));
            ...
            TrajectorySequence Dreapta = drive.trajectorySequenceBuilder(startPose)
                    .splineTo(new Vector2d(88, -92), Math.toRadians(90))
                    .setReversed(true)
            ...
            TrajectorySequence Stanga = drive.trajectorySequenceBuilder(startPose)
                    .splineTo(new Vector2d(60, -120), Math.toRadians(90))
                    .splineTo(new Vector2d(40, -87.5), Math.toRadians(135))
                    .setReversed(true)
                    .splineToLinearHeading(new Pose2d(88, -110, 0), Math.toRadians(90))
                    .setReversed(false)
            ...
            TrajectorySequence Centru = drive.trajectorySequenceBuilder(startPose)
                    .splineTo(new Vector2d(53, -73), Math.toRadians(90))
                    .setReversed(true)
