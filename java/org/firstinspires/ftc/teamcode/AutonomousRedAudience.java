...
public class AutonomousRedAudience extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            delay.reset();
            Pose2d startPose = new Pose2d(-60, -154, Math.toRadians(90));
            ...
            TrajectorySequence Dreapta = drive.trajectorySequenceBuilder(startPose)
                    .splineTo(new Vector2d(-90, -92), Math.toRadians(90))
                    .setReversed(true)
                    .splineToLinearHeading(new Pose2d(88, -110, 0), Math.toRadians(90))
                    .setReversed(false)
                    .splineTo(new Vector2d(164.4, -95), 0)
            ...
            TrajectorySequence Stanga = drive.trajectorySequenceBuilder(startPose)
                    .splineTo(new Vector2d(-60, -120), Math.toRadians(120))
                    .setReversed(true)
                    .splineToLinearHeading(new Pose2d(-60, -120, 0), Math.toRadians(0))
                    .setReversed(false)
                    .splineTo(new Vector2d(60,-120),0)
            ...
            TrajectorySequence Centru = drive.trajectorySequenceBuilder(startPose)
                    .splineTo(new Vector2d(-60, -63), Math.toRadians(90))
                    .setReversed(true)
                    .splineToLinearHeading(new Pose2d(-60, -120, 0), Math.toRadians(90))
                    .setReversed(false)
                    .splineTo(new Vector2d(60,-120),0)
                    .splineTo(new Vector2d(159.4, -87), 0)
                    .addDisplacementMarker(() ->
                    {
                        outtake.pixelLevelPreload();
                        outtake.setPid();
            ...
            switch (currentstate) {
                ...
                case goToBackdrop:
                    if (!drive.isBusy()) {
                        currentstate = AutonomousRedBackdrop.AutoStages.ridicare;
